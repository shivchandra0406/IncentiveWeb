...
export class EnhancedAuthServiceImpl implements AuthService {
  async login(credentials: LoginCredentials): Promise<LoginResponse> {
    try {
      const response = await enhancedApiClient.post<any>(
        `/Auth/login`,
        {
  ...
  async register(userData: RegisterUserData): Promise<User> {
    ...
    // const response = await enhancedApiClient.post<User>('/auth/register', userData);
...
export default new EnhancedAuthServiceImpl();
